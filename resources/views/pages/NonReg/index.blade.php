...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Non-Regular Employee</a></li>
                        <li class="breadcrumb-item active">Approval</li>
                    </ol>
                </div>
                <h4 class="page-title">Non-Regular Employee</h4>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select name="forApproval" id="forApproval" class="form-control">
                                        <option value="0" @if ($paramNonReg['forApproval'] == 0) {{ 'selected' }} @endif>For Approval</option>
                                        <option value="1" @if ($paramNonReg['forApproval'] == 1) {{ 'selected' }} @endif>Approved</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row pl-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="employeeName" id="employeeName" value="{{$paramNonReg['employeeName']}}" placeholder="Employee" class="form-control">
                                </div>
                            </div>
                            <div class="row pl-3">
                                <div class="col">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table id="tbl_nonreg_approval" class="table table-centered w-100 nowrap">
                        <thead>
                            <tr>
...
@endsection
@section('js')
<script src="{{ URL::asset('assets/js/custom/NonReg.js')}}"></script>
@endsection
