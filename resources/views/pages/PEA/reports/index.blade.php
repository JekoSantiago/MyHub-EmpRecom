...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-11">
            <a href="{{ route('RPT_NR') }}" target="_blank"><button type="button" class="btn btn-lg btn-outline-light" style="background-color: #2C8F4F;">Print Non-Regular Summary</button></a> &nbsp;
        </div>
    </div>
    <div class="row pt-4">
        <div class="col-12">
