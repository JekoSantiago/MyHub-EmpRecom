...
<div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select name="forRating" id="forRating" class="form-control select2no">
                                        <option value="-1" @if ($paramNPAAccept['forRating'] == -1) {{ 'selected' }} @endif>All</option>
                                        <option value="0" @if ($paramNPAAccept['forRating'] == 0) {{ 'selected' }} @endif>For Acceptance</option>
                                        <option value="1" @if ($paramNPAAccept['forRating'] == 1) {{ 'selected' }} @endif>Accepted</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row pl-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="employeeName" id="employeeName" value="{{$paramNPAAccept['employeeName']}}" placeholder="Employee" class="form-control">
                                </div>
                            </div>
                            <div class="row pl-3">
                                <div class="col-xxl">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <table id="tbl_npa_accept" class="table table-centered w-100 nowrap">
                        <thead>
                            <tr>
                                <th>Ratings</th>
                                <th>Employee No.</th>
...
@include('pages.Accept.npa.modals.modal_npa')
@endsection
@section('js')
<script src="{{ URL::asset('assets/js/custom/npa_acceptance.js')}}"></script>
@endsection
